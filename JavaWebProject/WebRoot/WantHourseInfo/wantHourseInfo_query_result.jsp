...
<div id="wantHourseInfo_manage_tool" style="padding:5px;">
	<div style="margin-bottom:5px;">
		...
		<a href="#" class="easyui-linkbutton" iconCls="icon-reload" plain="true"  onclick="wantHourseInfo_manage_tool.rent();">确定出租</a>
...
<div id="wantHourseInfoEditDiv">
	<form id="wantHourseInfoEditForm" enctype="multipart/form-data" action="/WantHourseInfo/agree"  method="post">
		<div>
